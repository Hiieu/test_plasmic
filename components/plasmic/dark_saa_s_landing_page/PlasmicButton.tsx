...
import sty from "./PlasmicButton.module.css"; // plasmic-import: 1CZRzZXcpQYh-/css
    ...
    >
      ...
      {(
        ...
        ? p.renderPlasmicSlot({
            defaultContents: (
              <svg
                className={classNames(projectcss.all, sty.svg__iaB2H)}
                role={"img"}
              />
            ),
      ...
      {(
        ...
        ? p.renderPlasmicSlot({
            defaultContents: (
              <svg
                className={classNames(projectcss.all, sty.svg__bAwPx)}
                role={"img"}
              />
            ),
