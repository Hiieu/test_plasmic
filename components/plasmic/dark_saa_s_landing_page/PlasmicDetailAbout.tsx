...
import sty from "./PlasmicDetailAbout.module.css"; // plasmic-import: VMOkyF7_uV7u7/css
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <div className={classNames(projectcss.all, sty.column__lRyKi)}>
            <p.PlasmicImg
          ...
          <div className={classNames(projectcss.all, sty.column__xUxD)}>
            <h5
